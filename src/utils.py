...
class AccuracyMetrics(object):
    ...
    def overall_metrics(self):
        ...
        labels = np.array(self.labels)
        res = OrderedDict()
        res['precision_score_macro'] = precision_score(labels, pred, average='macro')
        res['precision_score_micro'] = precision_score(labels, pred, average='micro')
        res['precision_score_weighted'] = precision_score(labels, pred, average='weighted')
        res['f1_score_macro'] = f1_score(labels, pred, average='macro')
        res['f1_score_micro'] = f1_score(labels, pred, average='micro')
        res['f1_score_weighted'] = f1_score(labels, pred, average='weighted')
        return res
